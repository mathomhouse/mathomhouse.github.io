            ...
            <div class="gear-slot">
              <div class="ht-icon-row">
                <div class="ht-icon-column">
                  <img src="/redesign/images/${chipKey.replace(/ /g, '%20')}-icon.png" alt="${ht.chipType}" title="${ht.chipType}" />
                  <div class="chip-name">${ht.chipType}</div>
                </div>
                <div class="ht-icon-column">
                  <img src="/redesign/images/${htKey.replace(/ /g, '%20')}-ht-icon.png" alt="${ht.trooper}" title="${ht.trooper}" />
