...
(function () {
  ...
  function attachCopyUI(overlay, dump) {
    ...
    status.textContent = 'Tap Copy. Then paste at https://mathomhouse.github.io/armory-report.html.';
    ...
    copyBtn.onclick = function () {
      function ok() {
        ...
        status.textContent = 'Paste at https://mathomhouse.github.io/armory-report.html → Paste from clipboard. Tap Close to dismiss.';
