...
const fontFixStyle = '<style id="ha-font-fix">:root{--mono:\'Rajdhani\',BlinkMacSystemFont,\'Segoe UI\',sans-serif!important;}html{font-family:\'Rajdhani\',BlinkMacSystemFont,\'Segoe UI\',sans-serif!important;font-size:16px!important;}body{font-family:\'Rajdhani\',BlinkMacSystemFont,\'Segoe UI\',sans-serif!important;font-size:14px!important;}button,input,select,textarea{font-family:inherit!important;}</style>';
